    ...
    <div id="wrapper" class="login-page">
        <div id="login_form" class="form">
            <%--<form class="register-form">--%>
                ...
                <%----%>
            <%--</form>--%>
            <form class="login-form" action="/wao/login2">
                <input type="text" placeholder="用户编号" id="userid"/>
                <input type="password" placeholder="密码" id="userpwd"/>
                <button id="login">登　录</button>
                <button id="guest" class="margin: 15px 0 0 0;" type="submit">游客</button>
        ...
        if (msg != ""){
            ...
            $.ajax({
                ...
                data: {
                    ...
                    if(data.flag=='yeah'){
                        $("#message").hide()
                        window.location.href="wao/openJsp?page=center"/*tpa=http://***index.html*/;
                    }else{
                        alert("what?");
